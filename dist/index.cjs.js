...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "SOAB" },
            React__default['default'].createElement("img", { src: "https://gateway.pinata.cloud/ipfs/QmUD6LcJfoFDSwzDKdewzUmnaVH6q389c1Xo5aqjcTFf3M", alt: "SOAB Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: banner, alt: "SOAB Logo", className: "desktop-icon" }))) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "SOAB" },
            React__default['default'].createElement("img", { src: "hhttps://gateway.pinata.cloud/ipfs/QmUD6LcJfoFDSwzDKdewzUmnaVH6q389c1Xo5aqjcTFf3M", alt: "SOAB Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: banner, alt: "SOAB Logo", className: "desktop-icon" })))));
};
var templateObject_1$c;
